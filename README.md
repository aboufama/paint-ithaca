...
There is no sample photo, camera-selection section, press-and-hold interaction, or changing headline. The viewfinder has a subtle 6px corner radius. Camera and photo data stay on the device; the existing backend is untouched.
...
Test pages and their photographic fixture are excluded from the published build. Physical camera permissions and front/rear switching should also be checked on target phones.
