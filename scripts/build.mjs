...
for (const file of ['index.html','styles.css','app.js','tidal-bloom.js','capture-session.js','submission-scene.js']) await cp(resolve(root,file), resolve(root,'dist',file));
...
await cp(resolve(root,'PHOTO-CREDITS.md'), resolve(root,'dist/PHOTO-CREDITS.md'));
